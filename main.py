...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", default="Patricia", help="Engine name to register")
    parser.add_argument("--engine", default="./patricia_aarch64", help="Shell command to launch UCI engine")
